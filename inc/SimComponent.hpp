#ifndef _SIM_COMPONENT_H_
#define _SIM_COMPONENT_H_

#include "SimObject.hpp"
#include "IComponent.h"

class SimComponent : public SimObject, public virtual Smp::IComponent
{
    public:

    virtual ~SimComponent() noexcept = default;
    
    SimComponent(Smp::String8 ObjectName) : SimObject(ObjectName) {};
    ...
    void Publish(
        Smp::IPublication* receiver) override;
    ...
    Smp::IField* GetField(
        Smp::String8 fullName) const override;
